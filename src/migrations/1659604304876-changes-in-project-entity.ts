...
export class changesInProjectEntity1659604304876 implements MigrationInterface {
    name = 'changesInProjectEntity1659604304876'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "project"
            ADD "budget" character varying NOT NULL
        `);
        await queryRunner.query(`
